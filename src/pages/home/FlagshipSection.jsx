...
const FlagShipSection = ({ location }) => {
  return (
    <div className='flagship-section'>
      <div className='section-left'>
        ...
        <div className='buttons'>
          <DarkPrimaryButton className='btn'>Explore</DarkPrimaryButton>
          <LightPrimaryButton>Create</LightPrimaryButton>
        </div>
      </div>
      <FlagshipCard
        className='section-card flagship-card'
        location={location}
      />
    </div>
  );
